...
public interface TempicServiceAsync {
    ...
    void getTemperatureDataFiltered(ArrayList<String> countryNames, String searchBy, int from, int to, double uncertainty, int limitTo, String aggregateBy, String groupByCityOrCountry, AsyncCallback<ArrayList<TemperatureData>> async);
    ...
    void getCityNames(AsyncCallback<ArrayList<String>> asyncCallback);
}
